...
class AppTheme {
  // Vintage pharmacy palette
  static const Color primary = Color(0xFF3D6B4F);        // deep pharmacy green
  static const Color primaryLight = Color(0xFF6B9E7E);
  static const Color primaryDark = Color(0xFF1B5E20);
  static const Color secondary = Color(0xFF8B6914);      // antique gold/brown
  static const Color accent = Color(0xFFC49A3C);         // warm gold

  static const Color background = Color(0xFFF2ECD8);     // parchment
  static const Color surface = Color(0xFFFAF5E8);        // light parchment
  static const Color cardBorder = Color(0xFFB8956A);     // copper/brown border
  static const Color navBar = Color(0xFF2C1F0E);         // dark wood
    ...
    return ThemeData(
      ...
      textTheme: GoogleFonts.latoTextTheme().copyWith(
        displayLarge: GoogleFonts.playfairDisplay(
          fontSize: 32, fontWeight: FontWeight.bold, color: textPrimary, height: 1.2,
        ),
        ...
        titleMedium: GoogleFonts.lato(
          fontSize: 16, fontWeight: FontWeight.w700, color: textPrimary, height: 1.4,
        ),
        bodyLarge: GoogleFonts.lato(
          fontSize: 16, fontWeight: FontWeight.normal, color: textPrimary, height: 1.5,
        ),
        bodyMedium: GoogleFonts.lato(
          fontSize: 14, fontWeight: FontWeight.normal, color: textSecondary, height: 1.5,
        ),
        bodySmall: GoogleFonts.lato(
          fontSize: 12, fontWeight: FontWeight.normal, color: textSecondary, height: 1.5,
        ),
